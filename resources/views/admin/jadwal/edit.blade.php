...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    @if($jadwals->isNotEmpty())
        <div class="bg-white shadow-sm rounded-2xl border border-slate-200 overflow-hidden">
            ...
            {{-- MODIFIKASI: Tambahkan max-h-[500px] dan overflow-y-auto --}}
            <div class="overflow-x-auto max-h-[500px] overflow-y-auto relative">
                <table class="min-w-full text-xs md:text-sm text-left border-collapse">
                    {{-- MODIFIKASI: Tambahkan sticky top-0 z-10 agar header menempel --}}
                    <thead class="bg-[#0D47C9] text-white sticky top-0 z-10 shadow-sm">
                        <tr>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Hari</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Waktu Sesi</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Mata Pelajaran</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Guru</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Ruang Lab</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800">Dibuat Oleh</th>
                            <th class="px-4 py-3 font-semibold uppercase tracking-wide text-white border-b border-blue-800 text-center">Aksi</th>
                        </tr>
                    </thead>
