...
<header class="bg-[#0B57D0] text-white shadow-md">
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-10 py-3 flex items-center justify-between">
        ...
        {{-- KANAN: PROFIL + HAMBURGER (MOBILE) --}}
        <div class="flex items-center gap-4">

            {{-- PROFIL BUTTON: Desktop selalu tampil, Mobile hanya untuk Kepsek --}}
            ...
            {{-- HAMBURGER: HANYA DI MOBILE dan BUKAN KEPSEK --}}
            @if(!$isKepsek)
    ...
    {{-- BARIS 2: NAV DESKTOP - HANYA TAMPIL JIKA BUKAN KEPSEK --}}
    @if(!$isKepsek)
    ...
    {{-- NAV MOBILE (LINK + LOGOUT) - HANYA TAMPIL JIKA BUKAN KEPSEK --}}
    @if(!$isKepsek)
